      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine on standby. Upload multiple unstructured data files to initialize simulation sequence.
          </p>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity relation extraction & agent profile generation & environment config agent injection of simulation parameters</div>
                </div>
              </div>
              <div class="workflow-item">
...
// Start simulation - navigate immediately, API calls made on Process page
...
:root {
  ...
  --border: #E5E5E5;
  /* 
    Using Space Grotesk as main heading font, JetBrains Mono for code/tag font
