        ...
        <div v-if="selectedProject" class="modal-overlay" @click.self="closeModal">
          <div class="modal-content">
            ...
            <div class="modal-playback-hint">
              <span class="hint-text">Step3 "Start Simulation" and Step5 "Deep Interaction" must be launched during runtime and do not support history playback</span>
            </div>
          </div>
        </div>
      </Transition>
  ...
  observer = new IntersectionObserver(
    (entries) => {
      entries.forEach((entry) => {
        ...
        // Update the pending target state (always record the latest target state regardless of animation status)
    ...
    },
    {
      ...
      // Adjust rootMargin: viewport bottom shrinks upward, requires more scrolling to trigger expansion
