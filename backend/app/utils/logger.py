...
Provides unified log management with output to both console and files
"""
...
def _ensure_utf8_stdout():
    ...
    Fixes garbled CJK characters in Windows console
    """
...
def get_logger(name: str = 'mirofish') -> logging.Logger:
    """
    Get logger (creates one if it does not exist)
