...
# Adding this prefix prevents Agents from calling tools, responding directly with text
...
def _check_simulation_prepared(simulation_id: str) -> tuple:
    """
    Check if simulation has been prepared
    ...
    try:
        ...
        # - running: Currently running, preparation completed long ago
        # - completed: Run complete, preparation completed long ago
        # - stopped: Stopped, preparation completed long ago
...
def prepare_simulation():
    ...
    try:
        ...
        # Check if preparation already complete (avoid duplicate generation)
            ...
            if is_prepared:
                ...
                return jsonify({
                    ...
                    "data": {
                        ...
                        "status": "ready",
                        "message": "Preparation already complete, no need for duplicate generation",
...
def _get_report_id_for_simulation(simulation_id: str) -> str:
    ...
    Returns the newest one (sorted by created_at) if multiple exist.
            ...
            "data": [
                {
                    "simulation_id": "sim_xxxx",
                    "project_id": "proj_xxxx",
                    "project_name": "Wuhan Univ Opinion Analysis",
    ...
    try:
        ...
        for sim in simulations:
            ...
            if run_state:
                ...
                # Use user-set total_rounds, fallback to recommended rounds if not set
...
def get_simulation_profiles_realtime(simulation_id: str):
    """
    Real-time get simulation Agent Profile (for viewing progress during generation)
...
def get_simulation_config_realtime(simulation_id: str):
    """
    Real-time get simulation config (for viewing progress during generation)
...
def get_simulation_config(simulation_id: str):
    """
    Get simulation config (LLM-generated full config)
    ...
    Returns:
        ...
        - generation_reasoning: LLM config reasoning notes
    """
    try:
        manager = SimulationManager()
...
def interview_all_agents():
    ...
    Request (JSON):
        {
            "simulation_id": "sim_xxxx",            // required, simulation ID
            "prompt": "What is your overall opinion?",  // required, interview question (same question for all Agents)
