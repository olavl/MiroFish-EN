    ...
    try:
        ...
        def run_generate():
            try:
                ...
                # Generate report (using pre-generated report_id)
...
def get_generate_status():
    ...
    try:
        ...
        # If simulation_id provided, check if a completed report already exists
        if simulation_id:
            existing_report = ReportManager.get_report_by_simulation(simulation_id)
            if existing_report and existing_report.status == ReportStatus.COMPLETED:
                return jsonify({
...
def chat_with_report_agent():
    ...
    Request (JSON):
        {
            "simulation_id": "sim_xxxx",        // Required, simulation ID
            "message": "Explain the opinion trends",  // Required, user message
