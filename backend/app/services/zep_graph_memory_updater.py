...
class AgentActivity:
    ...
    def _describe_like_post(self) -> str:
        ...
        if post_content and post_author:
            return f"liked {post_author}" + f"'s post: \"{post_content}\""
        elif post_content:
    ...
    def _describe_dislike_post(self) -> str:
        ...
        if post_content and post_author:
            return f"disliked {post_author}" + f"'s post: \"{post_content}\""
        elif post_content:
    ...
    def _describe_repost(self) -> str:
        ...
        if original_content and original_author:
            return f"reposted {original_author}" + f"'s post: \"{original_content}\""
    ...
    def _describe_create_comment(self) -> str:
        ...
        if content:
            if post_content and post_author:
                return f"commented on {post_author}" + f"'s post \"{post_content}\": \"{content}\""
            elif post_content:
                return f"commented on post \"{post_content}\": \"{content}\""
            elif post_author:
                return f"commented on {post_author}" + f"'s post: \"{content}\""
    ...
    def _describe_like_comment(self) -> str:
        ...
        if comment_content and comment_author:
            return f"liked {comment_author}" + f"'s comment: \"{comment_content}\""
    ...
    def _describe_dislike_comment(self) -> str:
        ...
        if comment_content and comment_author:
            return f"disliked {comment_author}" + f"'s comment: \"{comment_content}\""
        elif comment_content:
...
class ZepGraphMemoryUpdater:
    ...
    # Send interval (seconds) to avoid excessive request rate
    SEND_INTERVAL = 0.5
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args contains full context information (e.g. post content, user names, etc.).
                ...
                try:
                    ...
                    with self._buffer_lock:
                        ...
                        if len(self._platform_buffers[platform]) >= self.BATCH_SIZE:
                            ...
                            # Send interval to avoid excessive request rate
