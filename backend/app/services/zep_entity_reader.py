...
Reads nodes from Zep graph and filters for nodes matching predefined entity types
"""
...
class ZepEntityReader:
    ...
    def get_all_nodes(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        logger.info(f"Fetched a total of {len(nodes_data)}  nodes")
        return nodes_data
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        logger.info(f"Fetched a total of {len(edges_data)} edges")
        return edges_data
