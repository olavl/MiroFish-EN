...
class OasisProfileGenerator:
    ...
    def __init__(
        ...
        # Zep client for enriched context retrieval
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        ...
        Zep has no built-in hybrid search API, so edges and nodes must be searched separately then merged.
    ...
    def _is_group_entity(self, entity_type: str) -> bool:
        """Check if entity is group/institutional type"""
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """Get system prompt"""
        base_prompt = "You are a social media user profile generation expert. Generate detailed, realistic personas for opinion simulation, maximally restoring existing real-world situations. Must return valid JSON format, all string values must not contain unescaped newlines. Use Chinese."
        return base_prompt
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account setting for this institutional/group entity, maximally restoring existing real-world situations.
...
2. persona: Detailed account setting description (2000 characters of plain text), must include:
   - Institutional basic info (formal name, institution type, founding background, main functions)
...
- Institutional account posts must align with its identity positioning"""
