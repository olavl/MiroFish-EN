...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        try:
            ...
            # Set working directory to simulation directory (database and other files will be created here)
    ...
    def register_cleanup(cls):
        ...
        # If not in debug mode, this env var is absent, so registration is also needed
    ...
    def check_env_alive(cls, simulation_id: str) -> bool:
        ...
        Returns:
            True if environment is alive, False if it has been shut down
        """
        sim_dir = os.path.join(cls.RUN_STATE_DIR, simulation_id)
        if not os.path.exists(sim_dir):
            return False
    ...
    def interview_agent(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: For dual-platform simulations, interview on both platforms and return combined results
        ...
        if not ipc_client.check_env_alive():
            raise ValueError(f"Simulation environment not running or already closed, cannot perform Interview: {simulation_id}")
