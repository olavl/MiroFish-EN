...
class InterviewResult:
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            ...
            f"**Interviews Conducted:** {self.interviewed_count} / {self.total_agents} simulation Agents",
...
class ZepToolsService:
    ...
    4. interview_agents - In-depth interview (interviews simulation Agents, gets multi-perspective viewpoints)
    
    [Basic Tools]
    - search_graph - Graph semantic search
    - get_all_nodes - Get all graph nodes
    - get_all_edges - Get all graph edges (with time info)
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all edges from graph (paginated, with time info)

        Args:
            graph_id: Graph ID
            include_temporal: Whether to include time info (default True)
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Gets all graph edges and filters for those related to the specified node
    ...
    def insight_forge(
        ...
        Most powerful hybrid retrieval function, auto-decomposes questions and retrieves multi-dimensionally:
        1. Uses LLM to decompose question into multiple sub-queries
...
Return the sub-question list in JSON format."""
    ...
    def panorama_search(
        ...
        Gets full panoramic view, including all relevant content and historical/expired info:
        1. Gets all related nodes
        2. Gets all edges (including expired/invalidated)
        3. Categorizes and organizes current active and historical info
        
        This tool is suitable for scenarios requiring full event picture and tracking evolution process.
    ...
    def interview_agents(
        ...
        1. Auto-reads profile files to learn about all simulation Agents
        ...
        - Need to get real responses from simulation Agents (not LLM simulated)
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Strategy 2 (supplementary): Properly paired Chinese quotation marks content
                if not key_quotes:
